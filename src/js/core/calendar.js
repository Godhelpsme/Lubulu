...
import { getBeijingDate, getBeijingDateString, Analytics } from '../utils/helpers.js';
...
export class CalendarManager {
  ...
  handleDateClick(date, element) {
    ...
    // 记录分析数据
    Analytics.trackEvent('calendar_date_clicked', { date });
  }
  ...
  navigateMonth(direction) {
    ...
    this.render();
    Analytics.trackEvent('calendar_navigate', { 
  ...
  goToToday() {
    ...
    Analytics.trackEvent('calendar_go_to_today');
  }
